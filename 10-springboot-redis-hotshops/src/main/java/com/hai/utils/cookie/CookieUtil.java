...
public class CookieUtil {
    ...
    public final static String LOGIN_COOKIE_NAME = "ksd_login_token";
    public final static String LOGIN_COOKIE_NAME_ID = "ksd_login_token_id";
